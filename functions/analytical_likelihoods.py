...
def p_value_fixed_c(Nes, likelihood_norm, norm, ll_unnorm_max, dNes, data_list, shareddata):
    thetas = 1/Nes
    objective = lambda theta: hmm_add_likelihoods(theta, data_list, shareddata)
...
def confidence_interval_Ne_fixed_c(data_list, shareddata, p_thresh = 0.05):
    ...
    error_objective_array = lambda Nes: (p_value_fixed_c(Nes, likelihood_norm, norm, ll_unnorm_max, dNes, data_list, shareddata)-p_thresh)
