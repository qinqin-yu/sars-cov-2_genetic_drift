...
plt.tight_layout()
plt.savefig('../figure_outputs/england_inferred_Netau_exclude_ben_lineages_deterministic_summary.png', dpi = 300)
plt.savefig('../figure_outputs/england_inferred_Netau_exclude_ben_lineages_deterministic_summary.pdf')
