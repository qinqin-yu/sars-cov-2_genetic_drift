...
for shape in shapes:
    ...
    plt.tight_layout()
    plt.savefig('../figure_outputs/simulation_inferred_Netau_' + shape + '.png', dpi = 300)
    plt.savefig('../figure_outputs/simulation_inferred_Netau_' + shape + '.pdf')
