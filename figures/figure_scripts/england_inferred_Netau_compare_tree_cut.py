...
path_folders = ['../../data/lineages/B-1-177/B-1-177|2021-02-22|695.5',
                '../../data/lineages/B-1-177/B-1-177_sublineage692.5',
                '../../data/lineages/alpha/alpha|2021-06-20|61.5',
                '../../data/lineages/alpha/alpha_sublineage59.5',
                '../../data/lineages/delta/delta|2022-01-25|50.5+58.5',
                '../../data/lineages/delta/delta_sublineage50.5']
labels = ['B-1-177|2021-02-22|695.5',
          'B-1-177|2021-02-22|692.5',
          'alpha|2021-06-20|61.5',
         'alpha|2021-06-20|59.5',
         'delta|2022-01-25|50.5+58.5',
         'delta|2022-03-25|50.5']
...
plt.tight_layout()
plt.savefig('../../figures/figure_outputs/england_inferred_Netau_compare_tree_cut.png', dpi = 300)
plt.savefig('../../figures/figure_outputs/england_inferred_Netau_compare_tree_cut.pdf')
plt.show()