...
path_folder_all = '../../simulations/simulation_data/dfe_successive_mutations_control/'
...
for shape in shapes:
    ...
    ax[0].set_title('Neutral mutations')
    ...
    plt.tight_layout()
    plt.savefig('../figure_outputs/simulation_inferred_Netau_dfe_successive_mutations_control_' + shape + '.png', dpi = 300)
    plt.savefig('../figure_outputs/simulation_inferred_Netau_dfe_successive_mutations_control_' + shape + '.pdf')
