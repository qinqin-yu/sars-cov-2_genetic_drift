...
plt.tight_layout()
plt.savefig('../figure_outputs/simulation_inferred_Netau_gaussian_compare_MSD.png', dpi = 300)
plt.savefig('../figure_outputs/simulation_inferred_Netau_gaussian_compare_MSD.pdf')
