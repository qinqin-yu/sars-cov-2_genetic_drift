...
path_folder_all = '../../simulations/simulation_data/dfe/'
...
for shape in shapes:
    ...
    plt.tight_layout()
    plt.savefig('../figure_outputs/simulation_inferred_Netau_dfe_' + shape + '.png', dpi = 300)
    plt.savefig('../figure_outputs/simulation_inferred_Netau_dfe_' + shape + '.pdf')
