...
gamma_Es = [1/(1/7), (1/(7/7))]
gamma_Is = [1/(3/7), (1/(14/7))]

for i in range(len(gamma_Is)):
    gamma_I = gamma_Is[i]
    gamma_E = gamma_Es[i]
    ...
    merged.to_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_overall_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv')

    ######## GET SIR AND SEIR MODEL NETAU FOR BY VARIANTS OR LINEAGE ########
    
    merged = pd.read_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_overall_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv', index_col = 0)
    ...
    merged_variant.to_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_pre_B-1-177_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv')
    ...
    merged_variant.to_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_B-1-177_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv')
    ...
    merged_variant.to_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_alpha_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv')
    ...
    merged_variant.to_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_delta_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv')
    
    ######## MERGE WITH INFERENCE RESULTS ########
    
    summary_all = pd.DataFrame()
    
    df_Netau_variant = pd.read_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_pre_B-1-177_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv', index_col = 0)
    ...
    df_Netau_variant = pd.read_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_B-1-177_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv', index_col = 0)
    ...
    df_Netau_variant = pd.read_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_alpha_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv', index_col = 0)
    ...
    df_Netau_variant = pd.read_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_delta_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv', index_col = 0)
    ...
    summary_all.to_csv('../data/epidemiological_models/sensitivity_to_gammaI/epidemiological_models_Netau_inferred_Netau_by_variant_gammaI' + str(round(gamma_I,2)) + '_gammaE' + str(round(gamma_E,2)) + '.csv')