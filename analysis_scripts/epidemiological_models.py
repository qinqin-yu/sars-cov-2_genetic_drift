...
merged_variant.to_csv('../data/epidemiological_models/epidemiological_models_Netau_pre_B-1-177.csv')
...
merged_variant.to_csv('../data/epidemiological_models/epidemiological_models_Netau_B-1-177.csv')
...
merged_variant.to_csv('../data/epidemiological_models/epidemiological_models_Netau_alpha.csv')
...
merged_variant.to_csv('../data/epidemiological_models/epidemiological_models_Netau_delta.csv')

######## MERGE WITH INFERENCE RESULTS ########

summary_all = pd.DataFrame()

df_Netau_variant = pd.read_csv('../data/epidemiological_models/epidemiological_models_Netau_pre_B-1-177.csv', index_col = 0)
...
df_Netau_variant = pd.read_csv('../data/epidemiological_models/epidemiological_models_Netau_B-1-177.csv', index_col = 0)
...
df_Netau_variant = pd.read_csv('../data/epidemiological_models/epidemiological_models_Netau_alpha.csv', index_col = 0)
...
df_Netau_variant = pd.read_csv('../data/epidemiological_models/epidemiological_models_Netau_delta.csv', index_col = 0)
