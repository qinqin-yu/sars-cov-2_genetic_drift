...
if __name__ == '__main__':
    ...
    output_filename = 'raw_test_time_discretization.csv'
...
#    
    ...
    if parallel:
        ...
        for params in params_all:
            ...
            hmm_inference.infer_Ne_c(path_folder, \
                  ...
                  output_folder, \
                  output_filename, numtrials = 20, delta_t = 2)
    ...
    for params in params_all:
        ...
        output_filename = 'summary_test_time_discretization.csv'
        ...
        summary_corrected_full_filename = output_folder + 'summary_corrected_test_time_discretization.csv'
