...
if __name__ == '__main__':
    ...
    output_filename = 'raw_remove_c_bound.csv'
    ...
    if parallel:
        with Pool(processes = processes) as pool:
            result = pool.starmap(hmm_inference.infer_Ne_c_remove_c_bound, params_all)
    else:
        for params in params_all[3:4]:
            ...
            hmm_inference.infer_Ne_c_remove_c_bound(path_folder, \
                  counts_filename, \
    ...
    for params in params_all:
        ...
        output_filename = 'summary_remove_c_bound.csv'
        ...
        summary_corrected_full_filename = output_folder + 'summary_remove_c_bound_corrected.csv'
