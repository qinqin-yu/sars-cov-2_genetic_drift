...
#    processes = 16 # If using parallel processing, the number of parallel processes to run
    ...
    for mincount in mincounts: 
        ...
        output_filename = 'raw_superlineage_size_' + str(mincount) + '_counts.csv'
...
#        else:
        for params in params_all:
            ...
            hmm_inference.infer_Ne_c(path_folder, \
                  ...
                  output_folder, \
                  output_filename, mincount = mincount, numtrials = 20)
        ...
        for params in params_all:
            ...
            output_filename = 'summary_superlineage_size_' + str(mincount) + '_counts.csv'
            ...
            summary_corrected_full_filename = output_folder + 'summary_corrected_superlineage_size_' + str(mincount) + '_counts.csv'
