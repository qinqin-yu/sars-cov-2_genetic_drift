...
output_folder = path_folder + variant + '/microreact/is_pillar_2/England_random_subsample_one_tenth/'
...
save_counts_from_metadata_microreact(metadata_pillar2_subsample, variant_column, output_folder)
